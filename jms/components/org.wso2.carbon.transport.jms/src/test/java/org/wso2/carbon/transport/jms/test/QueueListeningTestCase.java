...
public class QueueListeningTestCase {
    ...
    @BeforeClass(groups = "queueListening", description = "Setting up the server, JMS listener and message processor") public void setUp() {
        listeningParametes = new HashMap<>();
        listeningParametes.put(JMSConstants.DESTINATION_PARAM_NAME, JMSTestConstants.QUEUE_NAME);
        listeningParametes.put(JMSConstants.CONNECTION_FACTORY_JNDI_PARAM_NAME,
                               JMSTestConstants.QUEUE_CONNECTION_FACTORY);
        listeningParametes.put(JMSConstants.NAMING_FACTORY_INITIAL_PARAM_NAME,
                               JMSTestConstants.ACTIVEMQ_FACTORY_INITIAL);
        listeningParametes
                .put(JMSConstants.PROVIDER_URL_PARAM_NAME, JMSTestConstants.ACTIVEMQ_PROVIDER_URL);
        listeningParametes.put(JMSConstants.CONNECTION_FACTORY_TYPE_PARAM_NAME,
    ...
    @Test(groups = "queueListening", description =
            "Testing whether queue listening is working correctly without any " +
        ...
        LOGGER.info("JMS Transport Listener is starting to listen to the queue " +
