 ...
 */
@Component(
        name = "org.wso2.carbon.transport.jms.internal.JMSServiceComponent",
        immediate = true,
        property = {
                "componentName=jms-transports-mgt"
        })
@SuppressWarnings("unused")
public class JMSServiceComponent  {

    private static final Logger log = LoggerFactory.getLogger(JMSServiceComponent.class);
